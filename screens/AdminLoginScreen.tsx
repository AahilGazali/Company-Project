                    ...
                    <G>
                      ...
                      <G>
                        ...
                        <G>
                          ...
                          <Path fill="url(#linear-gradient)" d="M118.9,81.08h4.81l.91,4.63c1.24.43,2.38,1.09,3.35,1.93l4.47-1.52,1.2,2.08,1.2,2.09-3.55,3.11c.12.62.19,1.27.19,1.93s-.06,1.3-.19,1.93l-3.55,3.11-1.2,2.08-1.2, 2.09-4.47-1.52c-.97.84-2.1,1.5-3.35,1.93l-.91,4.63h-4.81l-.92-4.63c-1.24-.43-2.37-1.09-3.35-1.93l-4.47,1.52-1.2-2.09-1.2-2.08,3.55-3.11c-.12-.63-.19-1.27-.19-1.93s.06-1.31.19-1.93l-3.55-3.11,1.2-2.09,1.2-2.08,4.47,1.52c.98-.84,2.11-1.5,3.35-1.93l.92-4.63ZM119.97,90.58c3.74-.99,7.07,2.34,6.08,6.08-.44,1.64-1.76,2.97-3.41,3.41-3.74.99-7.07-2.34-6.08-6.08.44-1.64,1.76-2.97,3.41-3.41Z"/>
                        </G>
                      </G>
                    </G>
                  </Svg>
