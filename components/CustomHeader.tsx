...
export default function CustomHeader({ title, showLogo = true }: CustomHeaderProps) {
  return (
        ...
        <View style={styles.headerContent}>
          {showLogo && (
            <View style={styles.logoContainer}>
              <Svg width={isTablet() ? 200 : 200} height={isTablet() ? 65 : 75} viewBox="0 0 765.73 230.07">
                <Defs>
                  <SvgLinearGradient id="linear-gradient" x1="275.68" y1="74.37" x2="275.68" y2="158.68" gradientUnits="userSpaceOnUse">
...
const styles = StyleSheet.create({
  ...
  headerBackground: {
    ...
    paddingTop: isSmallDevice() ? spacing.large : spacing.xxLarge,
