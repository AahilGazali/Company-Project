...
import Svg, { Path, Defs, LinearGradient as SvgLinearGradient, Stop, G, Polygon } from 'react-native-svg';
import { 
  spacing, 
  fontSize, 
  borderRadius, 
    ...
    <View style={[styles.headerContainer, isDatabaseScreen && styles.databaseHeaderContainer]}>
      <View style={[styles.headerBackground, isDatabaseScreen && styles.databaseHeaderBackground, dynamicStyles.headerBackground, isDatabaseScreen && dynamicStyles.databaseHeaderBackground]}>
        ...
        <View style={[styles.topBar, !isDatabaseScreen && styles.nonDatabaseTopBar]}>
          {showLogo && (
            <View style={isDatabaseScreen ? styles.databaseLogoSection : styles.logoSection}>
              <View style={isDatabaseScreen ? styles.databaseLogoContainer : styles.logoContainer}>
                <Svg width={isDatabaseScreen ? (isTablet() ? 250 : 220) : (isTablet() ? 200 : 180)} height={isDatabaseScreen ? (isTablet() ? 80 : 75) : (isTablet() ? 65 : 70)} viewBox="0 0 765.73 230.07">
                  <Defs>
                    <SvgLinearGradient
                      id="linear-gradient"
                      x1="275.68"
                    ...
                    <SvgLinearGradient id="linear-gradient-2" x1="330.36" y1="74.37" x2="330.36" y2="158.68">
                      <Stop offset="0" stopColor="#6dcf75" />
                      <Stop offset="1" stopColor="#008163" />
                    </SvgLinearGradient>
                    <SvgLinearGradient id="linear-gradient-3" x1="375.13" y1="74.37" x2="375.13" y2="158.68">
                      <Stop offset="0" stopColor="#6dcf75" />
                      <Stop offset="1" stopColor="#008163" />
                    </SvgLinearGradient>
                    <SvgLinearGradient id="linear-gradient-4" x1="456.58" y1="74.37" x2="456.58" y2="158.68">
                      <Stop offset="0" stopColor="#6dcf75" />
                      <Stop offset="1" stopColor="#008163" />
                    </SvgLinearGradient>
                    <SvgLinearGradient id="linear-gradient-5" x1="517.56" y1="74.37" x2="517.56" y2="158.68">
                      <Stop offset="0" stopColor="#6dcf75" />
                      <Stop offset="1" stopColor="#008163" />
                    </SvgLinearGradient>
                    <SvgLinearGradient id="linear-gradient-6" x1="566.83" y1="74.37" x2="566.83" y2="158.68">
                      <Stop offset="0" stopColor="#6dcf75" />
                      <Stop offset="1" stopColor="#008163" />
                    </SvgLinearGradient>
                    <SvgLinearGradient id="linear-gradient-7" x1="613.85" y1="74.37" x2="613.85" y2="158.68">
                      <Stop offset="0" stopColor="#6dcf75" />
                      <Stop offset="1" stopColor="#008163" />
                    </SvgLinearGradient>
                    <SvgLinearGradient id="linear-gradient-8" x1="661.33" y1="74.37" x2="661.33" y2="158.68">
                      <Stop offset="0" stopColor="#6dcf75" />
                      <Stop offset="1" stopColor="#008163" />
                    </SvgLinearGradient>
                    <SvgLinearGradient id="linear-gradient-9" x1="708.58" y1="74.37" x2="708.58" y2="158.68">
                      <Stop offset="0" stopColor="#6dcf75" />
                      <Stop offset="1" stopColor="#008163" />
                    </SvgLinearGradient>
                    <SvgLinearGradient id="linear-gradient-10" x1="752.23" y1="74.37" x2="752.23" y2="158.68">
                      <Stop offset="0" stopColor="#6dcf75" />
                      <Stop offset="1" stopColor="#008163" />
                    </SvgLinearGradient>
                    <SvgLinearGradient id="linear-gradient-11" x1="116.37" y1="-14.98" x2="176.11" y2="78.14">
                      <Stop offset="0" stopColor="#6dcf75" />
                      <Stop offset="1" stopColor="#008163" />
                    </SvgLinearGradient>
                    <SvgLinearGradient id="linear-gradient-12" x1="45.7" y1="30.35" x2="164.51" y2="215.55">
                      <Stop offset="0" stopColor="#6dcf75" />
                      <Stop offset="1" stopColor="#008163" />
                    </SvgLinearGradient>
                    <SvgLinearGradient id="linear-gradient-13" x1="116.37" y1="-14.98" x2="176.11" y2="78.14">
                      <Stop offset="0" stopColor="#6dcf75" />
                      <Stop offset="1" stopColor="#008163" />
                    </SvgLinearGradient>
                    <SvgLinearGradient id="linear-gradient-14" x1="54.95" y1="108.46" x2="105.25" y2="108.46">
                      <Stop offset="0" stopColor="#6dcf75" />
                      <Stop offset="1" stopColor="#008163" />
                    </SvgLinearGradient>
                    <SvgLinearGradient id="linear-gradient-15" x1="97.14" y1="135.59" x2="145.47" y2="135.59">
                      <Stop offset="0" stopColor="#6dcf75" />
                      <Stop offset="1" stopColor="#008163" />
                    </SvgLinearGradient>
                    <SvgLinearGradient id="linear-gradient-16" x1="107.77" y1="95.33" x2="134.84" y2="95.33">
                      <Stop offset="0" stopColor="#6dcf75" />
                      <Stop offset="1" stopColor="#008163" />
                    </SvgLinearGradient>
                  </Defs>
                  <G>
                    <G>
                      <Path
                        ...
                        d="M252.28,126.28v-37.8c0-4.08,1.23-7.35,3.69-9.81s5.73-3.69,9.81-3.69h19.8c4.08,0,7.35,1.23,9.81,3.69,2.46,2.46,3.69,5.73,3.69,9.81v37.8c0,4.08-1.23,7.35-3.69,9.81-2.46,2.46-5.73,3.69-9.81,3.69h-19.8c-4.08,0-7.35-1.23-9.81-3.69-2.46-2.46-3.69-5.73-3.69-9.81ZM269.38,129.88h12.6c4.2,0,6.3-2.1,6.3-6.3v-32.4c0-4.2-2.1-6.3-6.3-6.3h-12.6c-4.2,0-6.3,2.1-6.3,6.3v32.4c0,4.2,2.1,6.3,6.3,6.3Z"
                      />
                      <Path
                        fill="url(#linear-gradient-2)"
                        d="M310.78,154.18v-60.75h7.2l1.35,4.95h.45c.72-1.26,1.5-2.22,2.34-2.88,2.34-1.98,5.01-2.97,8.01-2.97h8.1c3.42,0,6.22,1.1,8.42,3.29,2.19,2.19,3.29,5,3.29,8.42v22.95c0,3.42-1.1,6.23-3.29,8.42-2.19,2.19-5,3.29-8.42,3.29h-17.1v15.3h-10.35ZM321.13,129.43h13.05c3.6,0,5.4-1.8,5.4-5.4v-16.65c0-3.6-1.8-5.4-5.4-5.4h-5.4c-5.1,0-7.65,2.55-7.65,7.65v19.8Z"
                      />
                      <Path
                        fill="url(#linear-gradient-3)"
                        d="M357.58,138.88v-9.45h21.15c2.4,0,3.6-1.2,3.6-3.6s-1.2-3.63-3.6-4.05l-10.35-2.25c-3.24-.66-5.85-2.05-7.83-4.19-1.98-2.13-2.97-4.63-2.97-7.51v-2.7c0-3.42,1.09-6.22,3.29-8.42,2.19-2.19,5-3.29,8.42-3.29h21.6v6.3l-3.15,3.15h-16.2c-2.4,0-3.6,1.2-3.6,3.6s1.2,3.63,3.6,4.05l10.35,2.25c3.24.66,5.85,2.06,7.83,4.19,1.98,2.13,2.97,4.64,2.97,7.52v2.7c0,3.42-1.1,6.23-3.29,8.42-2.19,2.19-5,3.29-8.42,3.29h-23.4Z"
                      />
                      <Path
                        fill="url(#linear-gradient-4)"
                        d="M421.93,138.88v-5.4l6.3-57.6h12.15l15.93,39.6h.54l15.93-39.6h12.15l6.3,57.6v5.4h-11.25l-3.6-45h-.45l-14.4,36h-9.9l-14.4-36h-.45l-3.6,45h-11.25Z"
                      />
                      <Path
                        fill="url(#linear-gradient-5)"
                        d="M498.88,128.09v-5.4c0-3.42,1.09-6.22,3.29-8.42,2.19-2.19,5-3.28,8.42-3.28h15.3v-2.7c0-3.6-1.8-5.4-5.4-5.4h-18v-9.45h22.05c3.42,0,6.22,1.1,8.42,3.29,2.19,2.19,3.29,5,3.29,8.42v33.75h-7.2l-1.35-4.95h-.45c-.66,1.26-1.44,2.25-2.34,2.97-2.28,1.92-4.95,2.88-8.01,2.88h-6.3c-3.42,0-6.23-1.09-8.42-3.28-2.19-2.19-3.29-5-3.29-8.42ZM514.18,130.34h4.5c2.28,0,4.05-.63,5.31-1.89,1.26-1.26,1.89-3.03,1.89-5.31v-3.15h-11.7c-3.3,0-4.95,1.65-4.95,4.95v.9c0,3.3,1.65,4.95,4.95,4.95Z"
                      />
                      <Path
                        fill="url(#linear-gradient-6)"
                        d="M547.93,138.88v-45.45h7.2l1.35,4.95h.45c.6-1.2,1.35-2.16,2.25-2.88,2.1-1.98,4.65-2.97,7.65-2.97h7.2c3.42,0,6.22,1.1,8.42,3.29,2.19,2.19,3.29,5,3.29,8.42v34.65h-10.35v-31.5c0-3.6-1.8-5.4-5.4-5.4h-4.05c-5.1,0-7.65,2.55-7.65,7.65v29.25h-10.35Z"
                      />
                      <Path
                      ...
                      <G>
                        <G>
                          <Polygon
                            ...
                            points="172.82 73.01 172.82 73.02 172.81 73.01 172.82 73.01"
                          />
                          <G>
                            <Path
